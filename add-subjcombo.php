...
<head>
 ...
 <!-- <link rel="stylesheet" href="css/form.css">  -->
    ...
    <title>Add Unit Combination</title>
</head>
...
<?php
    ...
      <form method="post" >
<!--     <fieldset> -->
      <h2 style="text-align:center; font-size : 30px">Add Unit Combination</h2>
       
 
...
<div style="margin-left : 50px; margin-bottom:50px">
    ...
    <select name="branch" id="branch" style = "padding : 5px; background-color : alicewhite; width:80%; font-size:17px">
        <option value="" style="font-size:17px">Select Course</option>
        <?php 
...
<label for="semester" >Year &nbsp;&nbsp; :&nbsp;&nbsp;   </label>
    ...
    <select name="semester" id="semester" style = "padding : 5px; background-color : alicewhite; width:80%; font-size:17px">
        <option value="" style="font-size:17px">Select Year</option>
        <?php 
...
<label for="subject" >Unit &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; :&nbsp;&nbsp;   </label>
    ...
    <select name="subject" id="subject" style = "padding : 5px; background-color : alicewhite; width:80%; font-size:17px">
        <option value="" style="font-size:17px">Select Unit</option>
        <?php 
        $stat = 1;
